...
import { sendmessagePOST, getHistory, getListPesan, deleteHistoryPesan, checkTotalMahasiswa, downloadHistory,downloadDataMahasiswa } from './routes/sendmessagePOST'
